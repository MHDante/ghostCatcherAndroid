...
/*
 * Management of the location is important in geo-based augmented reality applications.
 * Depending on the use-case location is used via GPS or network and may be updated every second
 * or once in a while. Although the SDKExamples project provides a basic implementation of
 * a LocationProvider this is by far not the best location strategy available for Android.
