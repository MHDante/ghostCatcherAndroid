...
public class gcLocationManager implements LocationListener {
    ...
    @Override public void onProviderEnabled(String provider) { setGPSStatus(); }
    @Override public void onProviderDisabled(String provider) { setGPSStatus();}
    ...
    public void removeUpdates() {locationManager.removeUpdates(this);}
