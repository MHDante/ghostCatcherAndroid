package ca.mixitmedia.ardemo.app;
...
import ca.mixitmedia.ardemo.app.utils.*;
...
public class DataView {
    ...
    public String[] places = new String[]{"SF Art Commission", "SF Dept. of Public Health", "SF Ethics Comm", "SF Conservatory of Music", "All Star Cafe",
